...
class _CreatePredictionDialogState extends State<CreatePredictionDialog> {
  ...
  Widget _buildStakeAmountField() {
    return TextFormField(
      ...
      validator: (value) {
        ...
        if (amount < 0.001) {
          return 'Minimum stake is 0.001 BDAG';
        }
        return null;
      },
    );
  ...
  Widget _buildPredictionSummary() {
    ...
    final changePercent = currentPrice > 0 ? (priceChange / currentPrice) * 100 : 0;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSummaryRow('Price Change:', '${changePercent.toStringAsFixed(2)}%'),
          _buildSummaryRow('Stake Amount:', '${stakeAmount.toStringAsFixed(4)} BDAG'),
          _buildSummaryRow(
            'Potential Reward:',
            '${potentialReward.toStringAsFixed(4)} BDAG',
